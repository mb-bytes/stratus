...
export const AnimatedNumber_002 = ({ finalCount = 0, className = "" }: { finalCount?: number; className?: string }) => {
  ...
  // Re-animate whenever finalCount updates while in view
  useEffect(() => {
    if (isInView) {
